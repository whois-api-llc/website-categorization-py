...
class WebsiteCategorizationApiError(Exception):
...
class ParameterError(WebsiteCategorizationApiError):
    pass


class EmptyApiKeyError(WebsiteCategorizationApiError):
    pass


class ResponseError(WebsiteCategorizationApiError):
    def __init__(self, message):
        self.message = message
...
class UnparsableApiResponseError(WebsiteCategorizationApiError):
...
class HttpApiError(WebsiteCategorizationApiError):
    pass
